...
export default function EarningsScreen() {
  ...
  // Placeholder flat rate per delivery — replace with your real payout formula.
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.note}>
        This is a placeholder calculation (₹{perDeliveryEarning}/delivery). Replace with your
        real payout logic — e.g. distance-based fee + incentives — on the backend, and expose it
        via a dedicated /api/delivery/earnings endpoint.
      </Text>
    </View>
  );
}
